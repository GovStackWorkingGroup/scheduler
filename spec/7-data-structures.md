...
| Deadline          | String (dd/hh/mm)                                | If participant doe not update attendance to scheduler within this deadline after an event starts, the participant is marked as no show. If all participants are in no-show status then the event status is no-show.  |
| Address           | Object                                           | location of the event                                                                                                                                                                                                |
| Status            | String                                           | pending/started/completed/noshow/etc                                                                                                                                                                                 |
...
| entity\_id         | integer        |  IDs of one or more events a resource is bound to within workhours of the resource in affiliated entity |
...
| Status poll URL  | String         | URL endpoint at which this Subscriber will report status of alert it received when queried             |
| Alert preference | String         | which channels (sms/email/webhook/etc) are preffered for alerting this Subscriber in order of priority |
...
| Event\_ID           | Integer        | the event to which this alert schedule is bound to |
